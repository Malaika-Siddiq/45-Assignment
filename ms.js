...
let quote = "He tongue is like a sword, use it with care.";
...
guestss.push("Sawera");
let middlee = Math.floor(guestss.length / 2);
...
// TASK 18
let countriesvisit = ["Canada", "Brazil", "Australia", "Denmark"];
// 1
...
// TASK 37
function shirt(size = "Large", printmessage = "I Love Typescript") {
...
let P_car = My_Car("Volkswagen Group ", "Audi A3", { color: "Grey", year: "2024" });
console.log(P_car);
export {};
